 ...
 *     setNumRows(numRows);
 *     
 *     # Changed because setNumRows(int numRows)
 *     # marked as obsolete
 */
 ...
 */
    ...
    if (columnNames == null) columnNames = new Vector(0);
 ...
 *    setColumnIdentifiers(columnNames);   
 *    
 *    # Changed because setColumnIdentifiers(Vector columnNames)
 *    # calls setDataVector(Vector newData, Vector columnNames)
 */
